...
[View on GitHub →](https://github.com/SankarshNellutla/ecommerce-pipeline){.project-link target="_blank" rel="noopener"}
:::
...
[View on GitHub →](https://github.com/SankarshNellutla/youtube-analytics){.project-link target="_blank" rel="noopener"}
:::
...
[View on GitHub →](https://github.com/SankarshNellutla/movie-recommender){.project-link target="_blank" rel="noopener"}
:::
...
[View on GitHub →](https://github.com/SankarshNellutla/emotion-detection){.project-link target="_blank" rel="noopener"}
:::
